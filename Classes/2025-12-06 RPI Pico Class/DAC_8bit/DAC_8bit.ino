...
void loop() {
  ...
  DACSet(0, 0x7f); // set DAC to mid scake (~1.65V)
  delay(1);
  sensorValue = analogRead(A0);
  Serial.print("DAC = 0x7f, ADC = ");
  ...
  DACSet(0, 0x00); // set DAC to minimum value (~0V)
  delay(1);
  sensorValue = analogRead(A0);
  Serial.print("DAC = 0x00, ADC = ");
  Serial.print(3.3 * sensorValue / 4096, 3);
  Serial.println("V");
